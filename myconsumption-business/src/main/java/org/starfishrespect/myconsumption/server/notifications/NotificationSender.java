package org.starfishrespect.myconsumption.server.notifications;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.starfishrespect.myconsumption.server.exceptions.InvalidRequestException;
...
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.GCM_SEND_ENDPOINT;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_CANONICAL_IDS;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_ERROR;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_FAILURE;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_MESSAGE_ID;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_MULTICAST_ID;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_PAYLOAD;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_REGISTRATION_IDS;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_RESULTS;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.JSON_SUCCESS;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_COLLAPSE_KEY;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_DELAY_WHILE_IDLE;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_DRY_RUN;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_PAYLOAD_PREFIX;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_REGISTRATION_ID;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_RESTRICTED_PACKAGE_NAME;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.PARAM_TIME_TO_LIVE;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.TOKEN_CANONICAL_REG_ID;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.TOKEN_ERROR;
import static org.starfishrespect.myconsumption.server.notifications.NotificationConstants.TOKEN_MESSAGE_ID;
