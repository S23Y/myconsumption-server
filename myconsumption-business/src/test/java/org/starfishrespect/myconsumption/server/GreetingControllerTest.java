...
import org.starfishrespect.myconsumption.server.controllers.GreetingController;
...
/**
 * @author Roy Clarkson, modified by Thibaud Ledent on 12.04.15.
 */
...
public class GreetingControllerTest {
    ...
    public void greetingAuthorized() throws Exception {
        String accessToken = getAccessToken("thib", "thib");
        ...
        mvc.perform(get("/greeting")
                ...
                .andExpect(jsonPath("$.content", is("Hello, thib!")));
        // @formatter:on
