...
public class DataRetriever {
    ...
    public DataRetriever(SensorDao sensorDao, ValuesDao valuesDao) {
    ...
    public boolean retrieveAll() {
        return retrieve(sensorDao.getAllSensors(), null);
    }
    ...
    public boolean retrieve(List<Sensor> sensors, String onlyThisSensorId) {
        ...
        for (Sensor sensor : sensors) {
            ...
            try {
                valuesDao.setSensor(sensor.getId());
                valuesDao.init();
                ...
                if (data.size() != 0) {
                    ...
                    for (int key : sortedValues.keySet()) {
                        ...
                        valuesDao.insertOrUpdate(newValue);
                    }
                    ...
                    int currentUsageCount = sensorDao.getUsageCount(sensor.getId());
