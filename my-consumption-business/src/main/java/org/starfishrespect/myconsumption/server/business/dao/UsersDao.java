...
public interface UsersDao {
     ...
     * @throws org.starfishrespect.myconsumption.server.business.exception.DaoException if the user is invalid (invalid name, null user, missing data, ...)
     */
     ...
     * @throws org.starfishrespect.myconsumption.server.business.exception.DaoException if the user is invalid
     */
